@echo off
powershell -Command "Invoke-WebRequest https://github.com/Tsu14-wq/avica/raw/main/.github/workflows/file_0000000050f4620a83633971bc2bf676.png -OutFile TranscodedWallpaper"
powershell -Command "Invoke-WebRequest https://github.com/Tsu14-wq/avica/raw/main/.github/workflows/file_0000000050f4620a83633971bc2bf676.png -OutFile CachedImage_1024_768_POS4.jpg"
